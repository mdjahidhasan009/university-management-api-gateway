...
const getAllFromDB = (req) => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield axios_1.CoreService.get('/offered-course-sections', {
        params: req.query,
        headers: {
...
const getByIdFromDB = (req) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const response = yield axios_1.CoreService.get(`/offered-course-sections/${id}`, {
        headers: {
            Authorization: req.headers.authorization
        }
    });
...
const insertIntoDB = (req) => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield axios_1.CoreService.post(`/offered-course-sections`, req.body, {
        headers: {
            Authorization: req.headers.authorization
        }
    });
...
const updateOneInDB = (req) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const response = yield axios_1.CoreService.patch(`/offered-course-sections/${id}`, req.body, {
        headers: {
            Authorization: req.headers.authorization
        }
    });
...
const deleteByIdFromDB = (req) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const response = yield axios_1.CoreService.delete(`/offered-course-sections/${id}`, {
        headers: {
            Authorization: req.headers.authorization
        }
    });
