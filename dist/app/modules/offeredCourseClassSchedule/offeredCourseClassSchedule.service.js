...
const getAllFromDB = (req) => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield axios_1.CoreService.get('/offered-course-class-schedules', {
        params: req.query,
        headers: {
...
const getByIdFromDB = (req) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const response = yield axios_1.CoreService.get(`/offered-course-class-schedules/${id}`, {
        headers: {
            Authorization: req.headers.authorization
        }
    });
...
const insertIntoDB = (req) => __awaiter(void 0, void 0, void 0, function* () {
    const response = yield axios_1.CoreService.post(`/offered-course-class-schedules`, req.body, {
        headers: {
            Authorization: req.headers.authorization
        }
    });
...
const updateOneInDB = (req) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const response = yield axios_1.CoreService.patch(`/offered-course-class-schedules/${id}`, req.body, {
        headers: {
            Authorization: req.headers.authorization
        }
    });
...
const deleteByIdFromDB = (req) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const response = yield axios_1.CoreService.delete(`/offered-course-class-schedules/${id}`, {
        headers: {
            Authorization: req.headers.authorization
        }
    });
