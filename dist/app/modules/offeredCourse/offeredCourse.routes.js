...
router.post('/', (0, validateRequest_1.default)(offeredCourse_validation_1.OfferedCourseValidation.create), (0, auth_1.default)(user_1.ENUM_USER_ROLE.SUPER_ADMIN, user_1.ENUM_USER_ROLE.ADMIN), offeredCourse_controller_1.OfferedCourseController.insertIntoDB);
router.patch('/:id', (0, validateRequest_1.default)(offeredCourse_validation_1.OfferedCourseValidation.update), (0, auth_1.default)(user_1.ENUM_USER_ROLE.SUPER_ADMIN, user_1.ENUM_USER_ROLE.ADMIN), offeredCourse_controller_1.OfferedCourseController.updateOneInDB);
